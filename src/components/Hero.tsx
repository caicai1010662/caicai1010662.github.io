  ...
  return (
    ...
    >
      ...
      <div className="max-w-3xl text-center">
        <p className="mb-4 text-sm font-medium uppercase tracking-widest text-gray-500 dark:text-gray-400">
          {t.tagline[locale]}
        </p>
        ...
        <p className="mx-auto mb-10 max-w-xl text-lg leading-relaxed text-gray-600 dark:text-gray-400">
