...
export default function ProjectCard({
  ...
  return (
    <article className="border-b border-gray-200 pb-12 pt-1 first:pt-0 last:border-b-0 dark:border-gray-800">
      <Link
        href={`/projects/${project.slug}`}
        className="group block overflow-hidden rounded-xl bg-gray-100 dark:bg-gray-900"
      >
      ...
      <div className="pt-5">
        <Link href={`/projects/${project.slug}`} className="group/title block">
          <h3 className="text-[1.65rem] font-semibold leading-snug tracking-tight text-gray-950 transition-colors group-hover/title:text-blue-600 dark:text-gray-100 dark:group-hover/title:text-blue-400 md:text-[1.85rem]">
